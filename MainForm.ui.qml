                ...
                TabBar {
                    ...
                    TabButton {
                        ...
                        background: Rectangle {
                            ...
                            Rectangle {
                                ...
                                height: 2
                                anchors.bottom: parent.bottom
                                color: parent.parent.checked ? "#E54B22" : "transparent"
                                radius: 1
                            }
                        }
                    }
                    ...
                    TabButton {
                        ...
                        contentItem: Text {
                            ...
                            color: parent.checked ? "#E54B22" : "#6B7280"
                            horizontalAlignment: Text.AlignHCenter
                            verticalAlignment: Text.AlignVCenter
                        }
            ...
            // Left: filters, summary, table
                ...
                ColumnLayout {
                    ...
                    OperationsTable {
                        ...
                        headers: ["Date", "heure", "Type op.", "Transaction", "Montant op.", "Montant versé", "Déductible", "Comm. CMI", "Bénéfice", "Bénéfice sup.", "Solde après", "Remarque"]

                        columnWidths: [100, 80, 110, 115, 115, 120, 105, 100, 100, 115, 115, 190]
                    }
                    RowLayout {
                        Layout.fillWidth: true
